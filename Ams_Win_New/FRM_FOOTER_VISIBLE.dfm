object FrmFooterVisible: TFrmFooterVisible
  ...
  AutoSize = True
  BorderIcons = []
  Caption = ' ак показывать итого-строки'
  Color = clBtnFace
  ...
  object FVFiltered: TRadioGroup
    ...
    Height = 56
    Align = alTop
    Caption = 'ќтфильтрованные позиции'
    ItemIndex = 0
    Items.Strings = (
      'показывать обычно'
      'показывать всегда'
  ...
  object FVSubTree: TRadioGroup
    ...
    Height = 56
    Align = alTop
    Caption = 'ѕо поддереву, начина€ с текущей категории'
    ItemIndex = 0
    Items.Strings = (
      'показывать обычно'
      'показывать всегда'
