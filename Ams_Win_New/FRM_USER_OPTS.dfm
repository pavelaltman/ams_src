object FrmUserOpts: TFrmUserOpts
  ...
  Caption = 'Пользовательские установки'
  ClientHeight = 188
  ClientWidth = 331
  Color = clBtnFace
  ...
  object ChBSortByDocNum: TCheckBox
    ...
    Caption = 'Сортировать по номеру документа'
    TabOrder = 5
  end
  object ChBGotoEnd: TCheckBox
    ...
    Height = 17
    Anchors = [akLeft, akTop, akRight]
    Caption = 'Становиться в конец списка'
    TabOrder = 6
  end
  object BBOk: TBitBtn
    Left = 2
